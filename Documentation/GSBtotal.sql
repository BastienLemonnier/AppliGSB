...
INSERT INTO `VISITEUR` (`MATRICULE`, `NOM`, `PRENOM`, `LOGIN`, `MDP`, `ADRESSE`, `TELEPHONE`, `CODEPOSTAL`, `DATEENTREE`, `PRIME`, `CODEUNIT`, `NOMUNIT`) VALUES
('a131', 'Villechalane', 'Louis', 'lvillachane', 'jux7g', '8 rue des Charmes', '0695942926', '46000', '2005-12-21', 0, 'SW', 'SWISS'),
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '0676095432', '46200', '1998-11-23', 0, 'BO', 'BOURDIN'),
('a55', 'Bedos', 'Christian', 'cbedos', 'gmhxd', '1 rue Peranud', '0676950362', '46250', '1995-01-12', 0, 'BO', 'BOURDIN'),
('a93', 'Tusseau', 'Louis', 'ltusseau', 'ktp3s', '22 rue des Ternes', '0643526187', '46123', '2000-05-01', 0, 'SW', 'SWISS'),
('b13', 'Bentot', 'Pascal', 'pbentot', 'doyw1', '11 allée des Cerises', '0684039215', '46512', '1992-07-09', 0, 'BO', 'BOURDIN'),
('b16', 'Bioret', 'Luc', 'lbioret', 'hrjfs', '1 Avenue gambetta', '0612134090', '46000', '1998-05-11', 0, 'SW', 'SWISS'),
('b19', 'Bunisset', 'Francis', 'fbunisset', '4vbnd', '10 rue des Perles', '0678905432', '93100', '1987-10-21', 0, 'BO', 'BOURDIN'),
('b25', 'Bunisset', 'Denise', 'dbunisset', 's1y1r', '23 rue Manin', '0634780954', '75019', '2010-12-05', 0, 'SW', 'SWISS'),
('b28', 'Cacheux', 'Bernard', 'bcacheux', 'uf7r3', '114 rue Blanche', '0627850136', '75017', '2009-11-12', 0, 'SW', 'SWISS'),
('b34', 'Cadic', 'Eric', 'ecadic', '6u8dc', '123 avenue de la République', '0678945623', '75011', '2008-09-23', 0, 'BO', 'BOURDIN'),
('b4', 'Charoze', 'Catherine', 'ccharoze', 'u817o', '100 rue Petit', '0605937321', '75019', '2005-11-12', 0, 'SW', 'SWISS'),
('b50', 'Clepkens', 'Christophe', 'cclepkens', 'bw1us', '12 allée des Anges', '0680564569', '93230', '2003-08-11', 0, 'BO', 'BOURDIN'),
('b59', 'Cottin', 'Vincenne', 'vcottin', '2hoh9', '36 rue Des Roches', '0612121212', '93100', '2001-11-18', 0, 'SW', 'SWISS'),
('c14', 'Daburon', 'François', 'fdaburon', '7oqpv', '13 rue de Chanzy', '0613131313', '94000', '2002-02-11', 0, 'SW', 'SWISS'),
('c3', 'De', 'Philippe', 'pde', 'gk9kx', '13 rue Barthes', '0614141414', '94000', '2010-12-14', 0, 'BO', 'BOURDIN'),
('c54', 'Debelle', 'Michel', 'mdebelle', 'od5rt', '181 avenue Barbusse', '0615151515', '93210', '2006-11-23', 0, 'BO', 'BOURDIN'),
('d13', 'Debelle', 'Jeanne', 'jdebelle', 'nvwqq', '134 allée des Joncs', '0616161616', '44000', '2000-05-11', 0, 'SW', 'SWISS'),
('d51', 'Debroise', 'Michel', 'mdebroise', 'sghkb', '2 Bld Jourdain', '0617171717', '44000', '2001-04-17', 0, 'BO', 'BOURDIN'),
('e22', 'Desmarquest', 'Nathalie', 'ndesmarquest', 'f1fob', '14 Place d Arc', '0618181818', '45000', '2005-11-12', 0, 'SW', 'SWISS'),
('e24', 'Desnost', 'Pierre', 'pdesnost', '4k2o5', '16 avenue des Cèdres', '0619191919', '23200', '2001-02-05', 0, 'BO', 'BOURDIN'),
('e39', 'Dudouit', 'Frédéric', 'fdudouit', '44im8', '18 rue de l église', '0620202020', '23120', '2000-08-01', 0, 'SW', 'SWISS'),
('e49', 'Duncombe', 'Claude', 'cduncombe', 'qf77j', '19 rue de la tour', '0621212121', '23100', '1987-10-10', 0, 'SW', 'SWISS'),
('e5', 'Enault-Pascreau', 'Céline', 'cenault', 'y2qdu', '25 place de la gare', '0622222222', '23200', '1995-09-01', 0, 'BO', 'BOURDIN'),
('e52', 'Eynde', 'Valérie', 'veynde', 'i7sn3', '3 Grand Place', '0623232323', '13015', '1999-11-01', 0, 'BO', 'BOURDIN'),
('f21', 'Finck', 'Jacques', 'jfinck', 'mpb3t', '10 avenue du Prado', '0624242424', '13012', '2001-11-10', 0, 'SW', 'SWISS'),
('f39', 'Frémont', 'Fernande', 'ffremont', 'xs5tq', '4 route de la mer', '0625252525', '13012', '1998-10-01', 0, 'BO', 'BOURDIN'),
('f4', 'Gest', 'Alain', 'agest', 'dywvt', '30 avenue de la mer', '0626262626', '13025', '1985-11-01', 0, 'SW', 'SWISS');
...
CREATE TABLE IF NOT EXISTS `VISITE` (
  ...
  FOREIGN KEY (`MATRICULE`) REFERENCES `VISITEUR` (`MATRICULE`),
  FOREIGN KEY (`CODEMED`) REFERENCES `MEDECIN` (`CODEMED`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `STOCKER` (`QTTSTOCK`, `MATRICULE`, `MED_DEPOTLEGAL`) VALUES
(35, 'a131', 'BACTIG10');
...
CREATE TABLE IF NOT EXISTS `OFFRIR` (
	`QTTDON` INT DEFAULT NULL,
	`REFERENCE` char(5) NOT NULL,
	`MED_DEPOTLEGAL` varchar(10) NOT NULL,
	
	FOREIGN KEY (`REFERENCE`) REFERENCES `VISITE` (`REFERENCE`),
	FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `MEDICAMENT` (`MED_DEPOTLEGAL`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `OFFRIR` (`QTTDON`, `REFERENCE`, `MED_DEPOTLEGAL`) VALUES
(5, 'v0017', 'BACTIG10'),
(10, 'v0009', 'BACTIG10');
