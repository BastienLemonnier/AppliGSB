...
public class OffrirDaoTest extends TestCase {
	...
	public final void testAjouterOffre() {
		Medicament leMedicament = new Medicament("3MYC7", "TRIMYCINE", "WindShield + Dash", "Risque de développer un cancer plus développé en cas de contact avec Katarina, arrêter le traitement dès que les premiers symptomes d'une telle infection se produiraient.", (float) 50.0, "AD", "Anti Dépresseur", 0, "");
	...
	public final void testAjouterOffreVisiteInexistante() {
		VisiteDao.delete("v5000");
		Medicament leMedicament = new Medicament("EZHASAGI", "ANTI-CANCER-POUR-HASAGI-PLAYER", "WindShield + Dash", "Risque de développer un cancer plus développé en cas de contact avec Katarina, arrêter le traitement dès que les premiers symptomes d'une telle infection se produiraient.", (float) 50.0, "AD", "Anti Dépresseur", 0, "");
		Visite laVisite = new Visite("v5000", "2002-01-20", "", new Medecin("m001", "", "", "", "", "", "", new Localite("", "")), new Visiteur("b59", "", "", "", "", "", new Localite("", ""), "", "", 0, "", ""));
